        ...
        <div className="card p-3">
          ...
          <form onSubmit={submit} className="row g-3">
            ...
            <div className="col-12 text-end">
              <button type="button" className="btn btn-secondary me-2" onClick={onClose} style={{ minWidth: '140px' }}>Cancel</button>
              <button type="submit" className="btn btn-primary" style={{ minWidth: '140px' }}>Update password</button>
            </div>
          </form>
        </div>
      </div>
