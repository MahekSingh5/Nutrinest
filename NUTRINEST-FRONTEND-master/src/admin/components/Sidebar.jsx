...
export default function Sidebar({
  ...
  const handleLogout = () => {
    logout();
    onClose();
    // navigate to login to ensure routes update immediately
    try {
      navigate("/login");
    } catch (e) {}
  };
  ...
  return (
    ...
    >
      <div className="p-3 d-flex align-items-center justify-content-between sidebar-header">
        ...
        <button
          className="btn btn-sm btn-close btn-close-white d-lg-none"
          onClick={onClose}
        ></button>
        <button
          className="btn btn-sm text-white d-none d-lg-block"
